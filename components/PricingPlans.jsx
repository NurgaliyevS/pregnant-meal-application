...
function PricingPlans() {
  return (
    <section className="container max-w-7xl mx-auto px-4 sm:px-8 py-10 lg:py-24" id="pricing">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
        <div className="bg-white p-6 lg:p-8 rounded-lg shadow-lg border border-primary border-opacity-20 flex flex-col h-full">
          <div className="text-center mb-4 lg:mb-6">
            <h3 className="font-bold text-xl lg:text-2xl mb-2 text-primary-focus">Yummy Starter</h3>
            <div className="text-3xl lg:text-4xl font-bold text-primary">$4.99</div>
            <p className="mt-2 text-sm lg:text-base text-gray-500">One-time payment</p>
          </div>
        ...
        <div className="bg-white p-6 lg:p-8 rounded-lg shadow-lg border-2 border-primary relative flex flex-col h-full">
          ...
          <div className="text-center mb-4 lg:mb-6">
            <h3 className="font-bold text-xl lg:text-2xl mb-2 text-primary-focus">Super Food Pack</h3>
            <div className="text-3xl lg:text-4xl font-bold text-primary">$9.99</div>
            <p className="mt-2 text-sm lg:text-base text-gray-500">One-time payment</p>
          </div>
        ...
        <div className="bg-white p-6 lg:p-8 rounded-lg shadow-lg border border-primary border-opacity-20 flex flex-col h-full">
          <div className="text-center mb-4 lg:mb-6">
            <h3 className="font-bold text-xl lg:text-2xl mb-2 text-primary-focus">Magic Mom Menu</h3>
            <div className="text-3xl lg:text-4xl font-bold text-primary">$19.99</div>
            <p className="mt-2 text-sm lg:text-base text-gray-500">One-time payment</p>
          </div>
